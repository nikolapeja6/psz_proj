...
def task5(num_of_clusters: int, original_dimensions: bool, features: list):
    ...
    visualize_nodes(labels, pca_2d, num_of_clusters, features, albums, 'task5', 'DBSCAN')
    ...
    if original_dimensions:
        ...
        labels = list(clustering.labels_)
        visualize_nodes(labels, pca_2d, num_of_clusters, features, albums, 'task5_b', 'DBSCAN')
